      ...
      async.forEach(histories, function(history, callback) {
        history.findLatest( function(err, relatedperson) {
          var entrywrapper = {
            ...
            id: "http://localhost:3000/relatedperson/@" + history.latestVersionId(),
            link: {
              href: "http://localhost:3000/relatedperson/@" + history.latestVersionId() + "/history/@" + history.versionCount(),
              rel: "self"
            },
