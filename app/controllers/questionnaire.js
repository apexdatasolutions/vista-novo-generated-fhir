      ...
      async.forEach(histories, function(history, callback) {
        history.findLatest( function(err, questionnaire) {
          var entrywrapper = {
            ...
            id: "http://localhost:3000/questionnaire/@" + history.latestVersionId(),
            link: {
              href: "http://localhost:3000/questionnaire/@" + history.latestVersionId() + "/history/@" + history.versionCount(),
              rel: "self"
            },
