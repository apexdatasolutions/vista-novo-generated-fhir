      ...
      async.forEach(histories, function(history, callback) {
        history.findLatest( function(err, medicationprescription) {
          var entrywrapper = {
            ...
            id: "http://localhost:3000/medicationprescription/@" + history.latestVersionId(),
            link: {
              href: "http://localhost:3000/medicationprescription/@" + history.latestVersionId() + "/history/@" + history.versionCount(),
              rel: "self"
            },
