  ...
  ResourceHistory.find({resourceType:"AdverseReaction"}, function (rhErr, histories) {
    ...
    async.forEach(histories, function(history, callback) {
      ...
      history.findLatest( function(err, adversereaction) {
        var entrywrapper = {
          title: "AdverseReaction " + history.vistaId + " Version " + history.versionCount(),
          id: "http://localhost:3000/adversereaction/@" + history.vistaId,
          link: {
            href: "http://localhost:3000/adversereaction/@" + history.vistaId + "/history/@" + history.versionCount(),
            rel: "self"
          },
