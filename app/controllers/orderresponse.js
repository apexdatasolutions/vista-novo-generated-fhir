      ...
      async.forEach(histories, function(history, callback) {
        history.findLatest( function(err, orderresponse) {
          var entrywrapper = {
            ...
            id: "http://localhost:3000/orderresponse/@" + history.latestVersionId(),
            link: {
              href: "http://localhost:3000/orderresponse/@" + history.latestVersionId() + "/history/@" + history.versionCount(),
              rel: "self"
            },
