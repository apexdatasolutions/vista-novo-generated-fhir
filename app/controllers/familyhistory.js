      ...
      async.forEach(histories, function(history, callback) {
        history.findLatest( function(err, familyhistory) {
          var entrywrapper = {
            ...
            id: "http://localhost:3000/familyhistory/@" + history.latestVersionId(),
            link: {
              href: "http://localhost:3000/familyhistory/@" + history.latestVersionId() + "/history/@" + history.versionCount(),
              rel: "self"
            },
