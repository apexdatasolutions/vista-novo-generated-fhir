      ...
      async.forEach(histories, function(history, callback) {
        history.findLatest( function(err, medicationadministration) {
          var entrywrapper = {
            ...
            id: "http://localhost:3000/medicationadministration/@" + history.latestVersionId(),
            link: {
              href: "http://localhost:3000/medicationadministration/@" + history.latestVersionId() + "/history/@" + history.versionCount(),
              rel: "self"
            },
